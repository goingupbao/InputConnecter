...
#define UI_WNDSTYLE_SKINDLG (WS_VISIBLE | WS_POPUP |WS_CAPTION|WS_THICKFRAME| WS_OVERLAPPED|WS_SYSMENU | WS_CLIPSIBLINGS | WS_CLIPCHILDREN |WS_MINIMIZEBOX|WS_MAXIMIZEBOX)
