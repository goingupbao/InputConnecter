...
CDuiString CPaintManagerUI::m_pStrDefaultResourceType;
...
void  CPaintManagerUI::SetResourceDefaultType(LPCTSTR pStrType)
{
    m_pStrDefaultResourceType = pStrType;
}
CDuiString CPaintManagerUI::GetResourceDefaultType()
{
    return m_pStrDefaultResourceType;
}
