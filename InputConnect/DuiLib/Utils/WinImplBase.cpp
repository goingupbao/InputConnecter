...
LRESULT WindowImplBase::OnNcUCHDrawCaption(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
LRESULT WindowImplBase::OnNcUCHDrawFrame(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
...
LRESULT WindowImplBase::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_NCUAHDRAWCAPTION:	lRes = OnNcUCHDrawCaption(uMsg, wParam, lParam, bHandled); break;
    case WM_NCUAHDRAWFRAME:		lRes = OnNcUCHDrawFrame(uMsg, wParam, lParam, bHandled); break;
#endif
