...
void CComboUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
    ...
    else if (_tcscmp(pstrName, _T("statusimage")) == 0)
    {
        m_diNormal.Clear();
        m_diNormal.sDrawString = pstrValue;
        ...
        m_diPushed.Clear();
        m_diPushed.sDrawString = pstrValue;
